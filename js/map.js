...
// Allowed facility types (same as analytics)
...
function loadFacilities() {
    ...
    console.log(`Loading from ${facilitiesData.length} facilities (filtering to ${ALLOWED_TYPES.size} types)`);
...
function filterFacilitiesByDistrict(districtName) {
    ...
    const sourceData = facilitiesData.filter(f => ALLOWED_TYPES.has(f.type));
